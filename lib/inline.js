...
function Inline(userId, ctx) {
  ...
  Inline.prototype._api = new Api(ctx.token);
}
...
Inline.prototype._editOptions = function (options) {
  let id = {
...
Inline.prototype.answerInlineQuery = function (results, options) {
  return this._api.answerInlineQuery(this.query.id, results, options).catch(this.error);
};
...
Inline.prototype.answerCallbackQuery = function (options) {
  return this._api.answerCallbackQuery(this.query.id, options).catch(this.error);
};

Inline.prototype.editMessageText = function (text, options) {
  return this._api.editMessageText(text, this._editOptions(options)).catch(this.error);
};

Inline.prototype.editMessageCaption = function (options) {
  return this._api.editMessageCaption(this._editOptions(options)).catch(this.error);
};

Inline.prototype.editMessageReplyMarkup = function (options) {
  return this._api.editMessageReplyMarkup(this._editOptions(options)).catch(this.error);
};
